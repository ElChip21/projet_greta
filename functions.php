...
function getAnnoncesByIdMembre($id){
    try{
        ...
        $db= connect();
        $query=$db->prepare('SELECT annonces.id_annonce,annonces.titre,annonces.description_annonces,annonces.prix_vente,annonces.id_utilisateur,annonces.actif FROM annonces  '.$sql);
